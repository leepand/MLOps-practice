...
image = dep_client.create_image(model, 'lr-model-instance', builder_args={'force_overwrite': True})
instance = dep_client.create_instance(image, 'lr-model-instance', port_mapping={9000: 9011}).run(detach=True)
instance.is_running
